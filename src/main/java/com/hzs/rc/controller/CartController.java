...
public class CartController {
    ...
    public void checkGood(@RequestParam("id")String id) {
        cartService.checkGood(Integer.valueOf(id));
    }

    @ApiOperation(value = "商品取消选择", notes = "取消选择")
    @PostMapping("/inCheckGood")
    public void inCheckGood(@RequestParam("id")String id) {
        cartService.inCheckGood(Integer.valueOf(id));
    }
